...
def calculate_cellular():
    try:
        ...
        erlang_table_path = "C:\\Users\\extreme\\Desktop\\wirelessproject\\home\\ubuntu\\wireless-network-complete-updated\\wireless-network-backend\\src\\routes\\Erlang-B-Table.csv"
